---
layout: post
title: Daryl Hosick - The Technology
...
## Daryl Hosick and SIP

Daryl Hosick is a visual object language and fully composable object framework. Instead of developing software using source code, programmers develop by visually connecting parts [(1)](#id-1) together.

Daryl Hosick is written in C# using [Mono](http://www.mono-project.com/Main_Page), [Monodevelop](http://monodevelop.com/), [Mono Touch](http://xamarin.com/monotouch) and [Visual Studio](http://www.microsoft.com/visualstudio/eng).

We're creating Daryl Hosick using a programming paradigm, we developed in-house, called Simple Interface Programming (SIP).

Before we delve into Daryl Hosick, let's talk about SIP and how it has allowed us to create Daryl Hosick.
...
Since Daryl Hosick is a [visual programming language](http://en.wikipedia.org/wiki/Visual_programming_language), users drag and drop parts to create them. Usually, a user will attach a new part to the property of an existing part.
...
### Some Advantages Of Daryl Hosick and SIP
Daryl Hosick has some of the following advantages over traditional methods of development:
...
The final “secret” of Daryl Hosick and SIP is composite centric memory. Composite centric memory has the following key aspects:
